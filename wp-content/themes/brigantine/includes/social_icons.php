...
<li class="et-social-icon et-social-tripadvisor">
		<a href="https://www.tripadvisor.ca/Hotel_Review-g182187-d609827-Reviews-s1-Brigantine_Inn-Lunenburg_Southwest_Nova_Scotia_Nova_Scotia.html" class="icon">
			<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/tripadvisor.svg" class="trip-size">
			<span><?php esc_html_e( 'Trip Advisor', 'Divi' ); ?></span>
		</a>
	</li>
