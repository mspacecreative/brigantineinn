...
<head>
	...
	<!-- TYPEKIT -->
	<script src="https://use.typekit.net/ecs1tdu.js"></script>
	...
	<!-- WEBREZ -->
	<link rel="stylesheet" type="text/css" href="<?php bloginfo( 'stylesheet_directory' ); ?>/css/engine_styles.css" />
	<link rel="stylesheet" type="text/css" href="<?php bloginfo( 'stylesheet_directory' ); ?>/css/jquery-ui-1.8.20.custom.css" />
	
	<script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js"></script>
	<script type="text/javascript" src="<?php bloginfo( 'stylesheet_directory' ); ?>/js/jquery.orbit-1.2.3.js"></script>
...
<script type="text/javascript">
$(function(){
$('#date_from').datepicker({clickInput:true, dateFormat:'yymmdd'});
$('#date_to').datepicker({clickInput:true, dateFormat:'yymmdd'});
});
</script>
...
?>
		...
		<header id="main-header" class="<?php echo esc_attr( $primary_nav_class ); ?>">
			...
			<div style="float: left; text-align: left;" id="cta"><span style="font-style: italic!important;">We're Open Year Round!</span>&nbsp;&nbsp;|&nbsp;&nbsp;82 Montague Street, Lunenburg, Nova Scotia, BOJ 2CO</div>
